...
This table lists the configuration variables required to operate EWS for Office 365. These variables are specified when configuring a Office 365 asset in Splunk SOAR.
...
action_result.data.\*.X-MS-Exchange-CrossTenant-AuthSource | string | | CO2NAM12FT063.eop-nam11.prod.protection.outlook.com |
...
action_result.data.\*.\*.\_\_metadata.id | string | `url` | https://reports.office365.com/ecp/ReportingWebService/Reporting.svc/MessageTrace(0) |
action_result.data.\*.\*.\_\_metadata.type | string | | TenantReporting.MessageTrace |
action_result.data.\*.\*.\_\_metadata.uri | string | `url` | https://reports.office365.com/ecp/ReportingWebService/Reporting.svc/MessageTrace(0) |
